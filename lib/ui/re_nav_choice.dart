...
class ReNavChoice extends StatefulWidget {
  final int team;
  final MyNavChosenCards myNavChosenCards;
  final OtherNavChosenCards otherNavChosenCards;
  ReNavChoice(this.team, this.myNavChosenCards, this.otherNavChosenCards);
  @override
  _ReNavChoiceState createState() => _ReNavChoiceState();
}

class _ReNavChoiceState extends State<ReNavChoice> {
  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints){
      ...
      if(widget.team == 1) {
        ...
        return Padding(
          padding: EdgeInsets.only(top: constr*0.4, right: constr*0.4),
          child: Container(
            height: constr * 1.75,
            width: constr * 1.5,
