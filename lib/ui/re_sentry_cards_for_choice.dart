...
class SentryCardsForChoiceUI extends StatefulWidget {
  final SentryCardsForChoiceStream sentryCardsForChoice;
  final SelectButtonStateStream buttonState;
  final ValueNotifier<bool> isSubmitted;
  SentryCardsForChoiceUI(this.sentryCardsForChoice, this.buttonState, this.isSubmitted);
  @override
  _SentryCardsForChoiceUIState createState() => _SentryCardsForChoiceUIState();
}

class _SentryCardsForChoiceUIState extends State<SentryCardsForChoiceUI> {
  final ScrollController scrollController = ScrollController();
  final ValueNotifier<Color> _progress = ValueNotifier<Color>(Color.fromRGBO(125, 133, 188, 0.15));
  final ValueNotifier<bool> _hasCards = ValueNotifier<bool>(false);
  Function onSelect;
  @override
  void initState() {
    // TODO: implement initState
    onSelect = (value){widget.sentryCardsForChoice.onSelect(value);};
    super.initState();
  }
  @override
                            ...
                            child: Container(
                               ...
                               */
                                child: StreamBuilder<List<MapItem>>(
                                    stream: widget.sentryCardsForChoice.sentryCards,
                                    //initialData: [],
                                      ...
                                      if(snapshot.hasData) {
                                       // setVisible();
                                        ...
                                        children: [
                                          ...
                                          stream: widget.sentryCardsForChoice.selectedCardsList,
                                        ...
                                        print('no data yet');
                                        //_hasCards.value=false;
                                        widget.sentryCardsForChoice.addToStream();
                                        return Container();
                                      }
                                    }
                                ),
...
//                          ),
                        ...
                        return Container(
                          ...
                          child: Center(
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(primary:  Color.fromRGBO(125, 133, 188, 0.15), padding: EdgeInsets.symmetric(horizontal: 150),
                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(100)), shadowColor: Colors.transparent),
                              child: Text('Подтвердить выбор карточек', style: Theme.of(context).textTheme.bodyText2,),
                            ),
                          ),
                        );
                      }
  ...
  void onSendConfirm() async{
   bool res = await widget.sentryCardsForChoice.confirm();
   print('res is $res');
   if(res){
  ...
  void resetColor() {
    ...
    Timer(Duration(seconds: 2), () {
      _progress.value = Theme.of(context).cardColor;
    });
